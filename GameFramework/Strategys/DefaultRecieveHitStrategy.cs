...
namespace GameFramework.Strategys
{
    ...
    /// </summary>
    /// <para>This strategy ensures that a creature's hit points are reduced by the specified amount, with
    ...
    public class DefaultRecieveHitStrategy : IRecieveHitStrategy
    {
        ...
        /// </summary>
        /// <para>If the resulting hit points are less than zero, they are set to zero.  This method
        /// has no effect if <paramref name="hit"/> is less than or equal to zero.</para>
